...
You need to input a control name for each comparison. The output figure size and some other parameters in the analyses can be changed in 'parameter_list.csv'.
